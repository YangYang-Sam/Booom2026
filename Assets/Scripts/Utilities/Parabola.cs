...
public struct Parabola
{
    ...
    public static Parabola CalculateSpeedAndAngleByTime(float time, float range, float altitude, out float speed, out float angle, float gravityMultiplier = 1f)
    {
    ...
    public static Parabola ABANDONED_CalculateSpeedByAngle(float angle, float range, float altitude, out float speed, float gravityMultiplier = 1f)
    {
        angle *= Mathf.Deg2Rad;
        float gravity = Physics.gravity.magnitude * gravityMultiplier;
    ...
    public static Parabola CalculateSpeedByAngle(float angle, float range, float altitude, out float speed, float gravityMultiplier = 1f)
    {
        float gravity = Physics.gravity.magnitude * gravityMultiplier;
        angle *= Mathf.Deg2Rad;
    ...
    public static Parabola CalculateSpeedAndAngleByHeight(float height, float range, float altitude, out float angle, out float speed, float gravityMultiplier = 1f)
    {
        float gravity = Physics.gravity.magnitude * gravityMultiplier;
    ...
    /// <param name="gravityMultiplier">Gravity multiplier.</param>
    public static Parabola[] CalculateAngleBySpeed(float speed, float range, float altitude, out float answer1, out float answer2, float gravityMultiplier = 1f)
    {
