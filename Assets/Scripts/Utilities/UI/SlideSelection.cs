...
namespace JTUtility.UI
{
    ...
    {
        [SerializeField] private Vector2 viewportExpandment = Vector2.zero;
        [SerializeField] private float spacing = 5;
        [SerializeField] private int numberOfShowingItems = 5;
        [SerializeField] private Vector2 itemSize = Vector2.zero;
        [SerializeField] private Sprite[] items = new Sprite[0];
        [SerializeField] private Gradient gradientByRange = null;
        [SerializeField] private AnimationCurve scaleByRange = new AnimationCurve();

        [SerializeField] private bool horizontal = false;
        [SerializeField] private Canvas viewport = null;
        [SerializeField] private Sprite idleMask = null;
        [SerializeField] private Sprite selectingMask = null;
        ...
        private Image viewportMaskImage = null;
        private Vector3 relativePosToPointer;

        private Vector2 viewportIdleSize;
        private Vector2 viewportExpandedSize;

        private Vector2 viewportRange;
        ...
        private int FindNearestImageIndex()
        {
            int minIndex = -1;
        ...
        private int GetItemIndexByImage(Image image)
        {
