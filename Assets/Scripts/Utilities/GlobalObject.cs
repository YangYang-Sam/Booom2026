...
namespace JTUtility
{
    ...
    /// </summary>
    public sealed class GlobalObject : MonoBehaviour
    {
        /// <summary>
        ...
        public static GlobalObject Instance
        {
            get
            {
                ...
                {
                    Debug.LogError("Accessing GlobalObject while game isn't running!");
                }
        ...
        {
            Debug.LogWarning("An instance of GlobalObject has been destroyed");
        }
