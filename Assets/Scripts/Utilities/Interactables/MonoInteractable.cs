...
namespace JTUtility.Interactables
{
    public abstract class MonoInteractable : MonoBehaviour, IInteractable
    {
        ...
        protected void InvokeStartInteracting()
        {
            if (OnStartInteracting != null) OnStartInteracting();
        }

        protected void InvokeKeepInteracting()
        {
            if (OnKeepInteracting != null) OnKeepInteracting();
        }

        protected void InvokeStopInteracting()
        {
            if (OnStopInteracting != null) OnStopInteracting();
        }
